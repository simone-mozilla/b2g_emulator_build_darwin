...
enum opt_code
{
  ...
  OPT_ansi = 416,                            /* -ansi */
  /* OPT_arch_errors_fatal = 417, */         /* -arch_errors_fatal */
  OPT_aux_info = 418,                        /* -aux-info */
  /* OPT_aux_info_ = 419, */                 /* -aux-info= */
  OPT_auxbase = 420,                         /* -auxbase */
  OPT_auxbase_strip = 421,                   /* -auxbase-strip */
  /* OPT_bind_at_load = 422, */              /* -bind_at_load */
  /* OPT_bootclasspath = 423, */             /* -bootclasspath */
  /* OPT_bundle = 424, */                    /* -bundle */
  /* OPT_bundle_loader = 425, */             /* -bundle_loader */
  OPT_c = 426,                               /* -c */
  /* OPT_classpath = 427, */                 /* -classpath */
  OPT_client_name = 428,                     /* -client_name */
  OPT_compatibility_version = 429,           /* -compatibility_version */
  OPT_coverage = 430,                        /* -coverage */
  OPT_cpp = 431,                             /* -cpp */
  OPT_cpp_ = 432,                            /* -cpp= */
  OPT_current_version = 433,                 /* -current_version */
  OPT_d = 434,                               /* -d */
  /* OPT_dead_strip = 435, */                /* -dead_strip */
  /* OPT_dependency_file = 436, */           /* -dependency-file */
  OPT_dumpbase = 437,                        /* -dumpbase */
  OPT_dumpdir = 438,                         /* -dumpdir */
  OPT_dumpmachine = 439,                     /* -dumpmachine */
  OPT_dumpspecs = 440,                       /* -dumpspecs */
  OPT_dumpversion = 441,                     /* -dumpversion */
  /* OPT_dylib_file = 442, */                /* -dylib_file */
  OPT_dylinker = 443,                        /* -dylinker */
  OPT_dylinker_install_name = 444,           /* -dylinker_install_name */
  /* OPT_dynamic = 445, */                   /* -dynamic */
  /* OPT_dynamiclib = 446, */                /* -dynamiclib */
  OPT_e = 447,                               /* -e */
  /* OPT_encoding = 448, */                  /* -encoding */
  OPT_export_dynamic = 449,                  /* -export-dynamic */
  /* OPT_exported_symbols_list = 450, */     /* -exported_symbols_list */
  OPT_extdirs = 451,                         /* -extdirs */
  /* OPT_fCLASSPATH_ = 452, */               /* -fCLASSPATH= */
  OPT_fPIC = 453,                            /* -fPIC */
  OPT_fPIE = 454,                            /* -fPIE */
  OPT_fRTS_ = 455,                           /* -fRTS= */
  OPT_fabi_version_ = 456,                   /* -fabi-version= */
  OPT_faccess_control = 457,                 /* -faccess-control */
  OPT_falign_commons = 458,                  /* -falign-commons */
  OPT_falign_functions = 459,                /* -falign-functions */
  OPT_falign_functions_ = 460,               /* -falign-functions= */
  OPT_falign_jumps = 461,                    /* -falign-jumps */
  OPT_falign_jumps_ = 462,                   /* -falign-jumps= */
  OPT_falign_labels = 463,                   /* -falign-labels */
  OPT_falign_labels_ = 464,                  /* -falign-labels= */
  OPT_falign_loops = 465,                    /* -falign-loops */
  OPT_falign_loops_ = 466,                   /* -falign-loops= */
  OPT_fall_intrinsics = 467,                 /* -fall-intrinsics */
  /* OPT_fall_virtual = 468, */              /* -fall-virtual */
  OPT_fallow_leading_underscore = 469,       /* -fallow-leading-underscore */
  /* OPT_falt_external_templates = 470, */   /* -falt-external-templates */
  OPT_fapple_kext = 471,                     /* -fapple-kext */
  /* OPT_fargument_alias = 472, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 473, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 474, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 475, */  /* -fargument-noalias-global */
  OPT_fasm = 476,                            /* -fasm */
  OPT_fassert = 477,                         /* -fassert */
  OPT_fassociative_math = 478,               /* -fassociative-math */
  OPT_fassume_compiled = 479,                /* -fassume-compiled */
  OPT_fassume_compiled_ = 480,               /* -fassume-compiled= */
  OPT_fasynchronous_unwind_tables = 481,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 482,                   /* -fauto-inc-dec */
  OPT_fautomatic = 483,                      /* -fautomatic */
  OPT_faux_classpath = 484,                  /* -faux-classpath */
  OPT_fbackslash = 485,                      /* -fbackslash */
  OPT_fbacktrace = 486,                      /* -fbacktrace */
  OPT_fblas_matmul_limit_ = 487,             /* -fblas-matmul-limit= */
  OPT_fbootclasspath_ = 488,                 /* -fbootclasspath= */
  OPT_fbootstrap_classes = 489,              /* -fbootstrap-classes */
  OPT_fbounds_check = 490,                   /* -fbounds-check */
  OPT_fbranch_count_reg = 491,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 492,           /* -fbranch-probabilities */
  OPT_fbranch_target_load_optimize = 493,    /* -fbranch-target-load-optimize */
  OPT_fbranch_target_load_optimize2 = 494,   /* -fbranch-target-load-optimize2 */
  OPT_fbtr_bb_exclusive = 495,               /* -fbtr-bb-exclusive */
  OPT_fbuiltin = 496,                        /* -fbuiltin */
  OPT_fbuiltin_ = 497,                       /* -fbuiltin- */
  OPT_fcall_saved_ = 498,                    /* -fcall-saved- */
  OPT_fcall_used_ = 499,                     /* -fcall-used- */
  OPT_fcaller_saves = 500,                   /* -fcaller-saves */
  OPT_fcheck_array_temporaries = 501,        /* -fcheck-array-temporaries */
  OPT_fcheck_data_deps = 502,                /* -fcheck-data-deps */
  OPT_fcheck_new = 503,                      /* -fcheck-new */
  OPT_fcheck_references = 504,               /* -fcheck-references */
  OPT_fcheck_ = 505,                         /* -fcheck= */
  OPT_fclasspath_ = 506,                     /* -fclasspath= */
  OPT_fcoarray_ = 507,                       /* -fcoarray= */
  OPT_fcombine_stack_adjustments = 508,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 509,                         /* -fcommon */
  OPT_fcompare_debug = 510,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 511,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 512,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 513,                   /* -fcompare-elim */
  OPT_fcompile_resource_ = 514,              /* -fcompile-resource= */
  OPT_fcond_mismatch = 515,                  /* -fcond-mismatch */
  OPT_fconserve_space = 516,                 /* -fconserve-space */
  OPT_fconserve_stack = 517,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 518,         /* -fconstant-string-class= */
  OPT_fconstexpr_depth_ = 519,               /* -fconstexpr-depth= */
  OPT_fconvert_big_endian = 520,             /* -fconvert=big-endian */
  OPT_fconvert_little_endian = 521,          /* -fconvert=little-endian */
  OPT_fconvert_native = 522,                 /* -fconvert=native */
  OPT_fconvert_swap = 523,                   /* -fconvert=swap */
  OPT_fcprop_registers = 524,                /* -fcprop-registers */
  OPT_fcray_pointer = 525,                   /* -fcray-pointer */
  OPT_fcrossjumping = 526,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 527,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 528, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 529,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 530,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 531,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 532,            /* -fd-lines-as-comments */
  OPT_fdata_sections = 533,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 534,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 535,                       /* -fdbg-cnt= */
  OPT_fdce = 536,                            /* -fdce */
  OPT_fdebug_prefix_map_ = 537,              /* -fdebug-prefix-map= */
  OPT_fdeduce_init_list = 538,               /* -fdeduce-init-list */
  OPT_fdefault_double_8 = 539,               /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 540, */           /* -fdefault-inline */
  OPT_fdefault_integer_8 = 541,              /* -fdefault-integer-8 */
  OPT_fdefault_real_8 = 542,                 /* -fdefault-real-8 */
  OPT_fdefer_pop = 543,                      /* -fdefer-pop */
  OPT_fdelayed_branch = 544,                 /* -fdelayed-branch */
  ...
  OPT_fdollar_ok = 552,                      /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 553,         /* -fdollars-in-identifiers */
  OPT_fdse = 554,                            /* -fdse */
  OPT_fdump_ = 555,                          /* -fdump- */
  OPT_fdump_core = 556,                      /* -fdump-core */
  OPT_fdump_final_insns = 557,               /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 558,              /* -fdump-final-insns= */
  OPT_fdump_fortran_optimized = 559,         /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 560,          /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 561,                  /* -fdump-go-spec= */
  OPT_fdump_noaddr = 562,                    /* -fdump-noaddr */
  OPT_fdump_parse_tree = 563,                /* -fdump-parse-tree */
  ...
  OPT_fenable_icf_debug = 580,               /* -fenable-icf-debug */
  ...
  /* OPT_fhonor_std = 632, */                /* -fhonor-std */
  OPT_fhosted = 633,                         /* -fhosted */
  /* OPT_fhuge_objects = 634, */             /* -fhuge-objects */
  OPT_fident = 635,                          /* -fident */
  OPT_fif_conversion = 636,                  /* -fif-conversion */
  OPT_fif_conversion2 = 637,                 /* -fif-conversion2 */
  OPT_filelist = 638,                        /* -filelist */
  ...
  OPT_findirect_virtual_calls = 646,         /* -findirect-virtual-calls */
  ...
  OPT_fintrinsic_modules_path = 663,         /* -fintrinsic-modules-path */
  OPT_fipa_cp = 664,                         /* -fipa-cp */
  OPT_fipa_cp_clone = 665,                   /* -fipa-cp-clone */
  OPT_fipa_matrix_reorg = 666,               /* -fipa-matrix-reorg */
  OPT_fipa_profile = 667,                    /* -fipa-profile */
  OPT_fipa_pta = 668,                        /* -fipa-pta */
  OPT_fipa_pure_const = 669,                 /* -fipa-pure-const */
  OPT_fipa_reference = 670,                  /* -fipa-reference */
  OPT_fipa_sra = 671,                        /* -fipa-sra */
  OPT_fipa_struct_reorg = 672,               /* -fipa-struct-reorg */
  OPT_fira_algorithm_ = 673,                 /* -fira-algorithm= */
  OPT_fira_loop_pressure = 674,              /* -fira-loop-pressure */
  OPT_fira_region_ = 675,                    /* -fira-region= */
  OPT_fira_share_save_slots = 676,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 677,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 678,                   /* -fira-verbose= */
  OPT_fivopts = 679,                         /* -fivopts */
  OPT_fjni = 680,                            /* -fjni */
  OPT_fjump_tables = 681,                    /* -fjump-tables */
  OPT_fkeep_inline_dllexport = 682,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 683,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 684,             /* -fkeep-static-consts */
  /* OPT_flabels_ok = 685, */                /* -flabels-ok */
  /* OPT_flat_namespace = 686, */            /* -flat_namespace */
  OPT_flax_vector_conversions = 687,         /* -flax-vector-conversions */
  OPT_fleading_underscore = 688,             /* -fleading-underscore */
  OPT_floop_block = 689,                     /* -floop-block */
  OPT_floop_flatten = 690,                   /* -floop-flatten */
  OPT_floop_interchange = 691,               /* -floop-interchange */
  /* OPT_floop_optimize = 692, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 693,           /* -floop-parallelize-all */
  OPT_floop_strip_mine = 694,                /* -floop-strip-mine */
  OPT_flto = 695,                            /* -flto */
  OPT_flto_compression_level_ = 696,         /* -flto-compression-level= */
  OPT_flto_partition_1to1 = 697,             /* -flto-partition=1to1 */
  OPT_flto_partition_balanced = 698,         /* -flto-partition=balanced */
  OPT_flto_partition_none = 699,             /* -flto-partition=none */
  OPT_flto_report = 700,                     /* -flto-report */
  OPT_flto_ = 701,                           /* -flto= */
  OPT_fltrans = 702,                         /* -fltrans */
  OPT_fltrans_output_list_ = 703,            /* -fltrans-output-list= */
  OPT_fmain_ = 704,                          /* -fmain= */
  OPT_fmath_errno = 705,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 706,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 707,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 708,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 709,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 710,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 711,                     /* -fmem-report */
  OPT_fmerge_all_constants = 712,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 713,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 714,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 715,                /* -fmessage-length= */
  OPT_fmodule_private = 716,                 /* -fmodule-private */
  OPT_fmodulo_sched = 717,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 718,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 719,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 720,                  /* -fms-extensions */
  OPT_fmudflap = 721,                        /* -fmudflap */
  OPT_fmudflapir = 722,                      /* -fmudflapir */
  OPT_fmudflapth = 723,                      /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 724, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 725, */                  /* -fnew-abi */
  OPT_fnext_runtime = 726,                   /* -fnext-runtime */
  OPT_fnil_receivers = 727,                  /* -fnil-receivers */
  OPT_fnon_call_exceptions = 728,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 729,               /* -fnonansi-builtins */
  /* OPT_fnonnull_objects = 730, */          /* -fnonnull-objects */
  OPT_fnothrow_opt = 731,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 732,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 733,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 734,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 735,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 736,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 737,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 738,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 739,                 /* -fobjc-std=objc1 */
  OPT_fomit_frame_pointer = 740,             /* -fomit-frame-pointer */
  OPT_fopenmp = 741,                         /* -fopenmp */
  OPT_foperator_names = 742,                 /* -foperator-names */
  OPT_foptimize_register_move = 743,         /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 744,         /* -foptimize-sibling-calls */
  OPT_foptimize_static_class_initialization = 745,/* -foptimize-static-class-initialization */
  /* OPT_foptional_diags = 746, */           /* -foptional-diags */
  /* OPT_force_cpusubtype_ALL = 747, */      /* -force_cpusubtype_ALL */
  /* OPT_force_flat_namespace = 748, */      /* -force_flat_namespace */
  OPT_foutput_class_dir_ = 749,              /* -foutput-class-dir= */
  OPT_fpack_derived = 750,                   /* -fpack-derived */
  OPT_fpack_struct = 751,                    /* -fpack-struct */
  OPT_fpack_struct_ = 752,                   /* -fpack-struct= */
  OPT_fpartial_inlining = 753,               /* -fpartial-inlining */
  OPT_fpcc_struct_return = 754,              /* -fpcc-struct-return */
  OPT_fpch_deps = 755,                       /* -fpch-deps */
  OPT_fpch_preprocess = 756,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 757,                     /* -fpeel-loops */
  OPT_fpeephole = 758,                       /* -fpeephole */
  OPT_fpeephole2 = 759,                      /* -fpeephole2 */
  OPT_fpermissive = 760,                     /* -fpermissive */
  OPT_fpic = 761,                            /* -fpic */
  OPT_fpie = 762,                            /* -fpie */
  OPT_fplan9_extensions = 763,               /* -fplan9-extensions */
  OPT_fplugin_arg_ = 764,                    /* -fplugin-arg- */
  OPT_fplugin_ = 765,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 766,            /* -fpost-ipa-mem-report */
  OPT_fpre_ipa_mem_report = 767,             /* -fpre-ipa-mem-report */
  OPT_fpredictive_commoning = 768,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 769,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 770,                   /* -fpreprocessed */
  OPT_fpretty_templates = 771,               /* -fpretty-templates */
  OPT_fprofile = 772,                        /* -fprofile */
  OPT_fprofile_arcs = 773,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 774,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 775,                   /* -fprofile-dir= */
  OPT_fprofile_generate = 776,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 777,              /* -fprofile-generate= */
  OPT_fprofile_use = 778,                    /* -fprofile-use */
  OPT_fprofile_use_ = 779,                   /* -fprofile-use= */
  OPT_fprofile_values = 780,                 /* -fprofile-values */
  OPT_fprotect_parens = 781,                 /* -fprotect-parens */
  OPT_framework = 782,                       /* -framework */
  OPT_frandom_seed = 783,                    /* -frandom-seed */
  OPT_frandom_seed_ = 784,                   /* -frandom-seed= */
  OPT_frange_check = 785,                    /* -frange-check */
  OPT_frealloc_lhs = 786,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 787,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 788,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 789,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 790,                /* -frecord-marker=8 */
  OPT_frecursive = 791,                      /* -frecursive */
  OPT_freduced_reflection = 792,             /* -freduced-reflection */
  OPT_freg_struct_return = 793,              /* -freg-struct-return */
  OPT_fregmove = 794,                        /* -fregmove */
  OPT_frename_registers = 795,               /* -frename-registers */
  OPT_freorder_blocks = 796,                 /* -freorder-blocks */
  OPT_freorder_blocks_and_partition = 797,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 798,              /* -freorder-functions */
  OPT_frepack_arrays = 799,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 800,           /* -freplace-objc-classes */
  OPT_frepo = 801,                           /* -frepo */
  OPT_frequire_return_statement = 802,       /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 803,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 804, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 805,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 806,                    /* -fresolution= */
  OPT_frounding_math = 807,                  /* -frounding-math */
  OPT_frtti = 808,                           /* -frtti */
  OPT_fsaw_java_file = 809,                  /* -fsaw-java-file */
  ...
  OPT_fschedule_insns = 828,                 /* -fschedule-insns */
  OPT_fschedule_insns2 = 829,                /* -fschedule-insns2 */
  OPT_fsecond_underscore = 830,              /* -fsecond-underscore */
  OPT_fsection_anchors = 831,                /* -fsection-anchors */
  /* OPT_fsee = 832, */                      /* -fsee */
  OPT_fsel_sched_pipelining = 833,           /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 834,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 835, /* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 836,           /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 837,          /* -fselective-scheduling2 */
  OPT_fshort_double = 838,                   /* -fshort-double */
  OPT_fshort_enums = 839,                    /* -fshort-enums */
  OPT_fshort_wchar = 840,                    /* -fshort-wchar */
  OPT_fshow_column = 841,                    /* -fshow-column */
  OPT_fsign_zero = 842,                      /* -fsign-zero */
  OPT_fsignaling_nans = 843,                 /* -fsignaling-nans */
  OPT_fsigned_bitfields = 844,               /* -fsigned-bitfields */
  OPT_fsigned_char = 845,                    /* -fsigned-char */
  OPT_fsigned_zeros = 846,                   /* -fsigned-zeros */
  OPT_fsingle_precision_constant = 847,      /* -fsingle-precision-constant */
  OPT_fsource_filename_ = 848,               /* -fsource-filename= */
  OPT_fsource_ = 849,                        /* -fsource= */
  OPT_fsplit_ivs_in_unroller = 850,          /* -fsplit-ivs-in-unroller */
  OPT_fsplit_stack = 851,                    /* -fsplit-stack */
  OPT_fsplit_wide_types = 852,               /* -fsplit-wide-types */
  /* OPT_fsquangle = 853, */                 /* -fsquangle */
  /* OPT_fstack_check = 854, */              /* -fstack-check */
  OPT_fstack_check_ = 855,                   /* -fstack-check= */
  OPT_fstack_limit = 856,                    /* -fstack-limit */
  OPT_fstack_limit_register_ = 857,          /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 858,            /* -fstack-limit-symbol= */
  OPT_fstack_protector = 859,                /* -fstack-protector */
  OPT_fstack_protector_all = 860,            /* -fstack-protector-all */
  OPT_fstack_usage = 861,                    /* -fstack-usage */
  OPT_fstats = 862,                          /* -fstats */
  OPT_fstore_check = 863,                    /* -fstore-check */
  /* OPT_fstrength_reduce = 864, */          /* -fstrength-reduce */
  OPT_fstrict_aliasing = 865,                /* -fstrict-aliasing */
  OPT_fstrict_enums = 866,                   /* -fstrict-enums */
  OPT_fstrict_overflow = 867,                /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 868, */         /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 869,      /* -fstrict-volatile-bitfields */
  OPT_fsyntax_only = 870,                    /* -fsyntax-only */
  OPT_ftabstop_ = 871,                       /* -ftabstop= */
  /* OPT_ftarget_help = 872, */              /* -ftarget-help */
  OPT_ftarget_ = 873,                        /* -ftarget= */
  /* OPT_ftemplate_depth_ = 874, */          /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 875,                /* -ftemplate-depth= */
  OPT_fterminated_vtables = 876,             /* -fterminated-vtables */
  OPT_ftest_coverage = 877,                  /* -ftest-coverage */
  /* OPT_fthis_is_variable = 878, */         /* -fthis-is-variable */
  OPT_fthread_jumps = 879,                   /* -fthread-jumps */
  OPT_fthreadsafe_statics = 880,             /* -fthreadsafe-statics */
  OPT_ftime_report = 881,                    /* -ftime-report */
  OPT_ftls_model_ = 882,                     /* -ftls-model= */
  OPT_ftoplevel_reorder = 883,               /* -ftoplevel-reorder */
  OPT_ftracer = 884,                         /* -ftracer */
  OPT_ftrapping_math = 885,                  /* -ftrapping-math */
  OPT_ftrapv = 886,                          /* -ftrapv */
  OPT_ftree_bit_ccp = 887,                   /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 888,          /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 889,                       /* -ftree-ccp */
  OPT_ftree_ch = 890,                        /* -ftree-ch */
  OPT_ftree_copy_prop = 891,                 /* -ftree-copy-prop */
  OPT_ftree_copyrename = 892,                /* -ftree-copyrename */
  OPT_ftree_cselim = 893,                    /* -ftree-cselim */
  OPT_ftree_dce = 894,                       /* -ftree-dce */
  OPT_ftree_dominator_opts = 895,            /* -ftree-dominator-opts */
  OPT_ftree_dse = 896,                       /* -ftree-dse */
  OPT_ftree_forwprop = 897,                  /* -ftree-forwprop */
  OPT_ftree_fre = 898,                       /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 899,  /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 900,         /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 901,           /* -ftree-loop-if-convert */
  OPT_ftree_loop_if_convert_stores = 902,    /* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 903,                   /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 904,              /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 905, */         /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 906,             /* -ftree-loop-optimize */
  OPT_ftree_lrs = 907,                       /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 908,        /* -ftree-parallelize-loops= */
  OPT_ftree_phiprop = 909,                   /* -ftree-phiprop */
  OPT_ftree_pre = 910,                       /* -ftree-pre */
  OPT_ftree_pta = 911,                       /* -ftree-pta */
  OPT_ftree_reassoc = 912,                   /* -ftree-reassoc */
  /* OPT_ftree_salias = 913, */              /* -ftree-salias */
  OPT_ftree_scev_cprop = 914,                /* -ftree-scev-cprop */
  OPT_ftree_sink = 915,                      /* -ftree-sink */
  OPT_ftree_slp_vectorize = 916,             /* -ftree-slp-vectorize */
  OPT_ftree_sra = 917,                       /* -ftree-sra */
  /* OPT_ftree_store_ccp = 918, */           /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 919, */     /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 920,         /* -ftree-switch-conversion */
  OPT_ftree_ter = 921,                       /* -ftree-ter */
  OPT_ftree_vect_loop_version = 922,         /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 923,                 /* -ftree-vectorize */
  OPT_ftree_vectorizer_verbose_ = 924,       /* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 925,                       /* -ftree-vrp */
  OPT_funderscoring = 926,                   /* -funderscoring */
  OPT_funit_at_a_time = 927,                 /* -funit-at-a-time */
  OPT_funroll_all_loops = 928,               /* -funroll-all-loops */
  OPT_funroll_loops = 929,                   /* -funroll-loops */
  OPT_funsafe_loop_optimizations = 930,      /* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 931,      /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 932,             /* -funsigned-bitfields */
  OPT_funsigned_char = 933,                  /* -funsigned-char */
  OPT_funswitch_loops = 934,                 /* -funswitch-loops */
  OPT_funwind_tables = 935,                  /* -funwind-tables */
  OPT_fuse_atomic_builtins = 936,            /* -fuse-atomic-builtins */
  OPT_fuse_boehm_gc = 937,                   /* -fuse-boehm-gc */
  OPT_fuse_cxa_atexit = 938,                 /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 939,      /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_divide_subroutine = 940,          /* -fuse-divide-subroutine */
  OPT_fuse_linker_plugin = 941,              /* -fuse-linker-plugin */
  OPT_fvar_tracking = 942,                   /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 943,       /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 944,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 945,            /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 946, /* -fvariable-expansion-in-unroller */
  OPT_fvect_cost_model = 947,                /* -fvect-cost-model */
  OPT_fverbose_asm = 948,                    /* -fverbose-asm */
  /* OPT_fversion = 949, */                  /* -fversion */
  OPT_fvisibility_inlines_hidden = 950,      /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 951,           /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 952,                    /* -fvisibility= */
  OPT_fvpt = 953,                            /* -fvpt */
  /* OPT_fvtable_gc = 954, */                /* -fvtable-gc */
  /* OPT_fvtable_thunks = 955, */            /* -fvtable-thunks */
  OPT_fweak = 956,                           /* -fweak */
  OPT_fweb = 957,                            /* -fweb */
  OPT_fwhole_file = 958,                     /* -fwhole-file */
  OPT_fwhole_program = 959,                  /* -fwhole-program */
  OPT_fwide_exec_charset_ = 960,             /* -fwide-exec-charset= */
  OPT_fworking_directory = 961,              /* -fworking-directory */
  OPT_fwpa = 962,                            /* -fwpa */
  OPT_fwrapv = 963,                          /* -fwrapv */
  /* OPT_fxref = 964, */                     /* -fxref */
  OPT_fzee = 965,                            /* -fzee */
  OPT_fzero_initialized_in_bss = 966,        /* -fzero-initialized-in-bss */
  OPT_fzero_link = 967,                      /* -fzero-link */
  OPT_g = 968,                               /* -g */
  OPT_gant = 969,                            /* -gant */
  OPT_gcoff = 970,                           /* -gcoff */
  OPT_gdwarf_ = 971,                         /* -gdwarf- */
  OPT_gen_decls = 972,                       /* -gen-decls */
  OPT_gfull = 973,                           /* -gfull */
  OPT_ggdb = 974,                            /* -ggdb */
  OPT_gnat = 975,                            /* -gnat */
  OPT_gnatO = 976,                           /* -gnatO */
  OPT_gno_strict_dwarf = 977,                /* -gno-strict-dwarf */
  ...
  OPT_gused = 982,                           /* -gused */
  OPT_gvms = 983,                            /* -gvms */
  OPT_gxcoff = 984,                          /* -gxcoff */
  OPT_gxcoff_ = 985,                         /* -gxcoff+ */
  OPT_h = 986,                               /* -h */
  OPT_headerpad_max_install_names = 987,     /* -headerpad_max_install_names */
  OPT_idirafter = 988,                       /* -idirafter */
  OPT_iframework = 989,                      /* -iframework */
  OPT_imacros = 990,                         /* -imacros */
  /* OPT_image_base = 991, */                /* -image_base */
  OPT_imultilib = 992,                       /* -imultilib */
  OPT_include = 993,                         /* -include */
  /* OPT_init = 994, */                      /* -init */
  /* OPT_install_name = 995, */              /* -install_name */
  OPT_iplugindir_ = 996,                     /* -iplugindir= */
  OPT_iprefix = 997,                         /* -iprefix */
  OPT_iquote = 998,                          /* -iquote */
  OPT_isysroot = 999,                        /* -isysroot */
  OPT_isystem = 1000,                        /* -isystem */
  OPT_iwithprefix = 1001,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1002,              /* -iwithprefixbefore */
  OPT_k8 = 1003,                             /* -k8 */
  OPT_keep_private_externs = 1004,           /* -keep_private_externs */
  OPT_l = 1005,                              /* -l */
  OPT_lang_asm = 1006,                       /* -lang-asm */
  OPT_m128bit_long_double = 1007,            /* -m128bit-long-double */
  OPT_m32 = 1008,                            /* -m32 */
  OPT_m3dnow = 1009,                         /* -m3dnow */
  OPT_m3dnowa = 1010,                        /* -m3dnowa */
  OPT_m64 = 1011,                            /* -m64 */
  OPT_m80387 = 1012,                         /* -m80387 */
  OPT_m8bit_idiv = 1013,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1014,             /* -m96bit-long-double */
  OPT_mabi_ = 1015,                          /* -mabi= */
  OPT_mabm = 1016,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1017,      /* -maccumulate-outgoing-args */
  OPT_maes = 1018,                           /* -maes */
  OPT_malign_double = 1019,                  /* -malign-double */
  OPT_malign_functions_ = 1020,              /* -malign-functions= */
  OPT_malign_jumps_ = 1021,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1022,                  /* -malign-loops= */
  OPT_malign_stringops = 1023,               /* -malign-stringops */
  OPT_march_ = 1024,                         /* -march= */
  OPT_masm_ = 1025,                          /* -masm= */
  OPT_matt_stubs = 1026,                     /* -matt-stubs */
  OPT_mavx = 1027,                           /* -mavx */
  OPT_mavx256_split_unaligned_load = 1028,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1029,  /* -mavx256-split-unaligned-store */
  OPT_mbmi = 1030,                           /* -mbmi */
  OPT_mbranch_cost_ = 1031,                  /* -mbranch-cost= */
  OPT_mcld = 1032,                           /* -mcld */
  OPT_mcmodel_ = 1033,                       /* -mcmodel= */
  OPT_mconstant_cfstrings = 1034,            /* -mconstant-cfstrings */
  /* OPT_mcpu_ = 1035, */                    /* -mcpu= */
  OPT_mcrc32 = 1036,                         /* -mcrc32 */
  OPT_mcx16 = 1037,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1038,            /* -mdispatch-scheduler */
  OPT_mdynamic_no_pic = 1039,                /* -mdynamic-no-pic */
  OPT_mf16c = 1040,                          /* -mf16c */
  OPT_mfancy_math_387 = 1041,                /* -mfancy-math-387 */
  OPT_mfentry = 1042,                        /* -mfentry */
  OPT_mfix_and_continue = 1043,              /* -mfix-and-continue */
  OPT_mfma = 1044,                           /* -mfma */
  OPT_mfma4 = 1045,                          /* -mfma4 */
  OPT_mforce_drap = 1046,                    /* -mforce-drap */
  OPT_mfp_ret_in_387 = 1047,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1048,                       /* -mfpmath= */
  OPT_mfsgsbase = 1049,                      /* -mfsgsbase */
  /* OPT_mfused_madd = 1050, */              /* -mfused-madd */
  OPT_mhard_float = 1051,                    /* -mhard-float */
  OPT_mieee_fp = 1052,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1053,      /* -mincoming-stack-boundary= */
  OPT_minline_all_stringops = 1054,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1055,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1056, */            /* -mintel-syntax */
  OPT_mkernel = 1057,                        /* -mkernel */
  OPT_mlarge_data_threshold_ = 1058,         /* -mlarge-data-threshold= */
  OPT_mlwp = 1059,                           /* -mlwp */
  OPT_mmacosx_version_min_ = 1060,           /* -mmacosx-version-min= */
  OPT_mmmx = 1061,                           /* -mmmx */
  OPT_mmovbe = 1062,                         /* -mmovbe */
  OPT_mms_bitfields = 1063,                  /* -mms-bitfields */
  OPT_mno_align_stringops = 1064,            /* -mno-align-stringops */
  OPT_mno_fancy_math_387 = 1065,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1066,                  /* -mno-push-args */
  OPT_mno_red_zone = 1067,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1068,                       /* -mno-sse4 */
  OPT_momit_leaf_frame_pointer = 1069,       /* -momit-leaf-frame-pointer */
  OPT_mone_byte_bool = 1070,                 /* -mone-byte-bool */
  OPT_mpc = 1071,                            /* -mpc */
  OPT_mpclmul = 1072,                        /* -mpclmul */
  OPT_mpopcnt = 1073,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1074,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1075,     /* -mpreferred-stack-boundary= */
  OPT_mpush_args = 1076,                     /* -mpush-args */
  OPT_mrdrnd = 1077,                         /* -mrdrnd */
  OPT_mrecip = 1078,                         /* -mrecip */
  OPT_mred_zone = 1079,                      /* -mred-zone */
  OPT_mregparm_ = 1080,                      /* -mregparm= */
  OPT_mrtd = 1081,                           /* -mrtd */
  OPT_msahf = 1082,                          /* -msahf */
  OPT_msoft_float = 1083,                    /* -msoft-float */
  OPT_msse = 1084,                           /* -msse */
  OPT_msse2 = 1085,                          /* -msse2 */
  OPT_msse2avx = 1086,                       /* -msse2avx */
  OPT_msse3 = 1087,                          /* -msse3 */
  OPT_msse4 = 1088,                          /* -msse4 */
  OPT_msse4_1 = 1089,                        /* -msse4.1 */
  OPT_msse4_2 = 1090,                        /* -msse4.2 */
  OPT_msse4a = 1091,                         /* -msse4a */
  /* OPT_msse5 = 1092, */                    /* -msse5 */
  OPT_msseregparm = 1093,                    /* -msseregparm */
  OPT_mssse3 = 1094,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1095,               /* -mstack-arg-probe */
  OPT_mstackrealign = 1096,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1097,            /* -mstringop-strategy= */
  OPT_mtbm = 1098,                           /* -mtbm */
  OPT_mtls_dialect_ = 1099,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1100,           /* -mtls-direct-seg-refs */
  OPT_mtune_ = 1101,                         /* -mtune= */
  /* OPT_multi_module = 1102, */             /* -multi_module */
  /* OPT_multiply_defined = 1103, */         /* -multiply_defined */
  /* OPT_multiply_defined_unused = 1104, */  /* -multiply_defined_unused */
  OPT_mveclibabi_ = 1105,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1106,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1107,                    /* -mvzeroupper */
  OPT_mxop = 1108,                           /* -mxop */
  OPT_n = 1109,                              /* -n */
  OPT_no_canonical_prefixes = 1110,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1111,              /* -no-integrated-cpp */
  /* OPT_no_dead_strip_inits_and_terms = 1112, *//* -no_dead_strip_inits_and_terms */
  OPT_nocpp = 1113,                          /* -nocpp */
  OPT_nodefaultlibs = 1114,                  /* -nodefaultlibs */
  OPT_nofixprebinding = 1115,                /* -nofixprebinding */
  OPT_nomultidefs = 1116,                    /* -nomultidefs */
  OPT_noprebind = 1117,                      /* -noprebind */
  OPT_noseglinkedit = 1118,                  /* -noseglinkedit */
  OPT_nostartfiles = 1119,                   /* -nostartfiles */
  OPT_nostdinc = 1120,                       /* -nostdinc */
  OPT_nostdinc__ = 1121,                     /* -nostdinc++ */
  OPT_nostdlib = 1122,                       /* -nostdlib */
  OPT_o = 1123,                              /* -o */
  OPT_object = 1124,                         /* -object */
  OPT_p = 1125,                              /* -p */
  OPT_pagezero_size = 1126,                  /* -pagezero_size */
  ...
  OPT_pie = 1131,                            /* -pie */
  OPT_pipe = 1132,                           /* -pipe */
  OPT_prebind = 1133,                        /* -prebind */
  OPT_prebind_all_twolevel_modules = 1134,   /* -prebind_all_twolevel_modules */
  OPT_preload = 1135,                        /* -preload */
  ...
  OPT_private_bundle = 1146,                 /* -private_bundle */
  OPT_pthread = 1147,                        /* -pthread */
  OPT_quiet = 1148,                          /* -quiet */
  OPT_r = 1149,                              /* -r */
  OPT_read_only_relocs = 1150,               /* -read_only_relocs */
  OPT_remap = 1151,                          /* -remap */
  OPT_s = 1152,                              /* -s */
  OPT_s_bc_abi = 1153,                       /* -s-bc-abi */
  OPT_save_temps = 1154,                     /* -save-temps */
  OPT_save_temps_ = 1155,                    /* -save-temps= */
  OPT_sectalign = 1156,                      /* -sectalign */
  OPT_sectcreate = 1157,                     /* -sectcreate */
  OPT_sectobjectsymbols = 1158,              /* -sectobjectsymbols */
  OPT_sectorder = 1159,                      /* -sectorder */
  OPT_seg1addr = 1160,                       /* -seg1addr */
  /* OPT_seg_addr_table = 1161, */           /* -seg_addr_table */
  /* OPT_seg_addr_table_filename = 1162, */  /* -seg_addr_table_filename */
  /* OPT_segaddr = 1163, */                  /* -segaddr */
  OPT_segcreate = 1164,                      /* -segcreate */
  OPT_seglinkedit = 1165,                    /* -seglinkedit */
  OPT_segprot = 1166,                        /* -segprot */
  /* OPT_segs_read_only_addr = 1167, */      /* -segs_read_only_addr */
  /* OPT_segs_read_write_addr = 1168, */     /* -segs_read_write_addr */
  OPT_shared = 1169,                         /* -shared */
  OPT_shared_libgcc = 1170,                  /* -shared-libgcc */
  /* OPT_single_module = 1171, */            /* -single_module */
  /* OPT_specs = 1172, */                    /* -specs */
  OPT_specs_ = 1173,                         /* -specs= */
  OPT_static = 1174,                         /* -static */
  OPT_static_libgcc = 1175,                  /* -static-libgcc */
  OPT_static_libgcj = 1176,                  /* -static-libgcj */
  OPT_static_libgfortran = 1177,             /* -static-libgfortran */
  OPT_static_libgo = 1178,                   /* -static-libgo */
  OPT_static_libstdc__ = 1179,               /* -static-libstdc++ */
  /* OPT_std_c__03 = 1180, */                /* -std=c++03 */
  OPT_std_c__0x = 1181,                      /* -std=c++0x */
  ...
  OPT_std_f95 = 1190,                        /* -std=f95 */
  OPT_std_gnu = 1191,                        /* -std=gnu */
  ...
  OPT_sub_library = 1204,                    /* -sub_library */
  OPT_sub_umbrella = 1205,                   /* -sub_umbrella */
  ...
  OPT_twolevel_namespace = 1213,             /* -twolevel_namespace */
  OPT_twolevel_namespace_hints = 1214,       /* -twolevel_namespace_hints */
  OPT_u = 1215,                              /* -u */
  /* OPT_umbrella = 1216, */                 /* -umbrella */
  OPT_undef = 1217,                          /* -undef */
  OPT_undefined = 1218,                      /* -undefined */
  /* OPT_unexported_symbols_list = 1219, */  /* -unexported_symbols_list */
  OPT_v = 1220,                              /* -v */
  OPT_version = 1221,                        /* -version */
  OPT_w = 1222,                              /* -w */
  /* OPT_weak_reference_mismatches = 1223, *//* -weak_reference_mismatches */
  OPT_whatsloaded = 1224,                    /* -whatsloaded */
  OPT_whyload = 1225,                        /* -whyload */
  OPT_wrapper = 1226,                        /* -wrapper */
  OPT_x = 1227,                              /* -x */
  OPT_y = 1228,                              /* -y */
  OPT_z = 1229,                              /* -z */
  N_OPTS,
